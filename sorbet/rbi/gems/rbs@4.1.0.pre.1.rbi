...
# source://rbs//lib/rbs/ast/ruby/annotations.rb#398
class RBS::AST::Ruby::Annotations::BlockParamTypeAnnotation < ::RBS::AST::Ruby::Annotations::Base
  ...
  #
  # source://rbs//lib/rbs/ast/ruby/annotations.rb#401
  ...
  #
  # source://rbs//lib/rbs/ast/ruby/annotations.rb#399
  ...
  # source://rbs//lib/rbs/ast/ruby/annotations.rb#412
  def map_type_name(&block); end

  # source://rbs//lib/rbs/ast/ruby/annotations.rb#426
  def name; end
  ...
  # @return [Boolean]
  #
  # source://rbs//lib/rbs/ast/ruby/annotations.rb#430
  def optional?; end
  ...
  # @return [Boolean]
  #
  # source://rbs//lib/rbs/ast/ruby/annotations.rb#434
  def required?; end
  ...
  # source://rbs//lib/rbs/ast/ruby/annotations.rb#438
...
class RBS::AST::Ruby::Annotations::ModuleSelfAnnotation < ::RBS::AST::Ruby::Annotations::Base
  ...
  # source://rbs//lib/rbs/ast/ruby/annotations.rb#371
  def map_type_name; end
...
# source://rbs//lib/rbs/ast/ruby/declarations.rb#233
class RBS::AST::Ruby::Declarations::ClassModuleAliasDecl < ::RBS::AST::Ruby::Declarations::Base
  ...
  #
  # source://rbs//lib/rbs/ast/ruby/declarations.rb#240
  def initialize(buffer, node, new_name, infered_old_name, leading_comment, annotation); end

  # Returns the value of attribute annotation.
  #
  # source://rbs//lib/rbs/ast/ruby/declarations.rb#238
  def annotation; end

  # source://rbs//lib/rbs/ast/ruby/declarations.rb#274
  def comment; end

  # Returns the value of attribute infered_old_name.
  #
  # source://rbs//lib/rbs/ast/ruby/declarations.rb#237
  def infered_old_name; end

  # Returns the value of attribute leading_comment.
  #
  # source://rbs//lib/rbs/ast/ruby/declarations.rb#235
  def leading_comment; end

  # source://rbs//lib/rbs/ast/ruby/declarations.rb#249
  def location; end

  # source://rbs//lib/rbs/ast/ruby/declarations.rb#253
  def name_location; end

  # Returns the value of attribute new_name.
  #
  # source://rbs//lib/rbs/ast/ruby/declarations.rb#236
  def new_name; end

  # Returns the value of attribute node.
  #
  # source://rbs//lib/rbs/ast/ruby/declarations.rb#234
  def node; end

  # source://rbs//lib/rbs/ast/ruby/declarations.rb#262
  def old_name; end

  # source://rbs//lib/rbs/ast/ruby/declarations.rb#278
  def type_fingerprint; end
end

# source://rbs//lib/rbs/ast/ruby/declarations.rb#171
class RBS::AST::Ruby::Declarations::ConstantDecl < ::RBS::AST::Ruby::Declarations::Base
  ...
  #
  # source://rbs//lib/rbs/ast/ruby/declarations.rb#177
  def initialize(buffer, constant_name, node, leading_comment, type_annotation); end

  # source://rbs//lib/rbs/ast/ruby/declarations.rb#219
  def comment; end

  # Returns the value of attribute constant_name.
  #
  # source://rbs//lib/rbs/ast/ruby/declarations.rb#173
  def constant_name; end

  # Returns the value of attribute leading_comment.
  #
  # source://rbs//lib/rbs/ast/ruby/declarations.rb#172
  def leading_comment; end

  # source://rbs//lib/rbs/ast/ruby/declarations.rb#185
  def location; end

  # source://rbs//lib/rbs/ast/ruby/declarations.rb#189
  def name_location; end

  # Returns the value of attribute node.
  #
  # source://rbs//lib/rbs/ast/ruby/declarations.rb#174
  def node; end

  # source://rbs//lib/rbs/ast/ruby/declarations.rb#198
  def type; end
...
class RBS::AST::Ruby::Declarations::ModuleDecl < ::RBS::AST::Ruby::Declarations::Base
  ...
  # source://rbs//lib/rbs/ast/ruby/declarations.rb#152
  def location; end
  ...
  # source://rbs//lib/rbs/ast/ruby/declarations.rb#156
  def name_location; end
  ...
  # source://rbs//lib/rbs/ast/ruby/declarations.rb#160
  def type_fingerprint; end
...
# source://rbs//lib/rbs/ast/ruby/members.rb#721
class RBS::AST::Ruby::Members::ModuleSelfMember < ::RBS::AST::Ruby::Members::Base
  ...
  #
  # source://rbs//lib/rbs/ast/ruby/members.rb#724
  def initialize(buffer, annotation); end

  # Returns the value of attribute annotation.
  #
  # source://rbs//lib/rbs/ast/ruby/members.rb#722
  def annotation; end

  # source://rbs//lib/rbs/ast/ruby/members.rb#733
  def args; end

  # source://rbs//lib/rbs/ast/ruby/members.rb#737
  def location; end

  # source://rbs//lib/rbs/ast/ruby/members.rb#729
  def name; end

  # source://rbs//lib/rbs/ast/ruby/members.rb#741
  def type_fingerprint; end
end
...
class RBS::Collection::Config::LockfileGenerator
  ...
  #
  # source://rbs//lib/rbs/collection/config/lockfile_generator.rb#51
  def config; end
  ...
  # source://rbs//lib/rbs/collection/config/lockfile_generator.rb#120
  def assign_gem(name:, version:, skip: T.unsafe(nil)); end

  # source://rbs//lib/rbs/collection/config/lockfile_generator.rb#188
  def assign_stdlib(name:, from_gem: T.unsafe(nil)); end

  # source://rbs//lib/rbs/collection/config/lockfile_generator.rb#259
  def find_best_version(version:, versions:); end

  # source://rbs//lib/rbs/collection/config/lockfile_generator.rb#253
  ...
  class << self
    # source://rbs//lib/rbs/collection/config/lockfile_generator.rb#53
...
class RBS::Environment
  ...
  # source://rbs//lib/rbs/environment.rb#982
  ...
  # source://rbs//lib/rbs/environment.rb#998
  def buffers; end
  ...
  # source://rbs//lib/rbs/environment.rb#993
  def inspect; end
  ...
  # source://rbs//lib/rbs/environment.rb#868
  def resolve_member(resolver, map, member, context:); end

  # source://rbs//lib/rbs/environment.rb#968
  ...
  # source://rbs//lib/rbs/environment.rb#1002
...
class RBS::InlineParser::Parser < ::Prism::Visitor
  ...
  # source://rbs//lib/rbs/inline_parser.rb#496
  ...
  # source://rbs//lib/rbs/inline_parser.rb#339
  def parse_attribute_call(node); end

  # source://rbs//lib/rbs/inline_parser.rb#399
  def parse_constant_declaration(node); end

  # source://rbs//lib/rbs/inline_parser.rb#283
  def parse_mixin_call(node); end

  # source://rbs//lib/rbs/inline_parser.rb#532
  ...
  # source://rbs//lib/rbs/inline_parser.rb#504
  def report_unused_annotation(*annotations); end

  # source://rbs//lib/rbs/inline_parser.rb#519
  ...
  # source://rbs//lib/rbs/inline_parser.rb#241
  def visit_call_node(node); end

  # source://rbs//lib/rbs/inline_parser.rb#103
  def visit_class_node(node); end

  # source://rbs//lib/rbs/inline_parser.rb#167
  def visit_class_or_module_body(decl, node); end

  # source://rbs//lib/rbs/inline_parser.rb#277
  def visit_constant_path_write_node(node); end

  # source://rbs//lib/rbs/inline_parser.rb#270
  def visit_constant_write_node(node); end

  # source://rbs//lib/rbs/inline_parser.rb#202
  def visit_def_node(node); end

  # source://rbs//lib/rbs/inline_parser.rb#125
...
# source://rbs//lib/rbs/rewriter.rb#4
class RBS::Rewriter
  # @return [Rewriter] a new instance of Rewriter
  #
  # source://rbs//lib/rbs/rewriter.rb#7
  def initialize(buffer); end

  # source://rbs//lib/rbs/rewriter.rb#25
  def add_comment(*locations, content:); end

  # Returns the value of attribute buffer.
  #
  # source://rbs//lib/rbs/rewriter.rb#5
  def buffer; end

  # source://rbs//lib/rbs/rewriter.rb#43
  def delete_comment(comment); end

  # source://rbs//lib/rbs/rewriter.rb#36
  def replace_comment(comment, content:); end

  # source://rbs//lib/rbs/rewriter.rb#14
  def rewrite(location, string); end

  # source://rbs//lib/rbs/rewriter.rb#51
  def string; end

  private

  # source://rbs//lib/rbs/rewriter.rb#63
